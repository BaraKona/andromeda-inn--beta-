          ...
          <div className="App">
            <Switch>
              ...
              <ProjectProvider>
                ...
                <PrivateRoute exact path={`/inn/project-view/:id`} component={ProjectView}/>
                <PrivateRoute exact path={`/inn/project-view/:id/component/:id/:position`} component={ProjectComponentView}/>
